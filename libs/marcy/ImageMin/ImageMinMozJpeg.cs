...
public sealed class ImageMinMozJpeg : ImageMinBinVendor<ImageMinMozJpegOptions>
{
    ...
    private static readonly string BaseUrl = $"https://raw.githubusercontent.com/imagemin/mozjpeg-bin/v{MozJpegBinVersion}/vendor/";
    ...
    public ImageMinMozJpeg(ImageMinMozJpegOptions? defaultOptions = null)
        ...
        (
            ...
            (
                ...
                new OsDependendSource($"{BaseUrl}win/cjpeg.exe", "cjpeg.exe", OSPlatform.Windows, x64: true),
                }
            ),
    ...
    protected override ImmutableList<string> GetArgs(string input, string output, ImageMinMozJpegOptions options)
    {
