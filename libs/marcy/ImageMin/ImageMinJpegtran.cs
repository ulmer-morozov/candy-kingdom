...
public sealed class ImageMinJpegtran : ImageMinBinVendor<ImageMinJpegtranOptions>
{
    ...
    private static readonly string BaseUrl = $"https://raw.githubusercontent.com/imagemin/jpegtran-bin/v{JpegtranBinVersion}/vendor/";
        ...
        (
            ...
            (
                ...
                sources: new[]
                {
                    ...
                    new OsDependendSource($"{BaseUrl}linux/x64/jpegtran", "jpegtran", OSPlatform.Linux, x64: true),
                    new OsDependendSource($"{BaseUrl}win/x64/jpegtran.exe", "jpegtran.exe", OSPlatform.Windows, x64: true),
                    new OsDependendSource($"{BaseUrl}win/x64/libjpeg-62.dll", "libjpeg-62.dll", OSPlatform.Windows, x64: true),
                }
            ),
    ...
    protected override ImmutableList<string> GetArgs(string input, string output, ImageMinJpegtranOptions options)
    {
