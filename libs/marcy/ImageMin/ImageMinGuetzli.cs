...
public sealed class ImageMinGuetzli : ImageMinBinVendor<ImageMinGuetzliOptions>
{
    ...
    private static readonly string BaseUrl = $"https://raw.githubusercontent.com/imagemin/guetzli-bin/v{GuetzliBinVersion}/vendor/";
        ...
        (
            ...
            (
                ...
                sources: new[]
                {
                    ...
                    new OsDependendSource($"{BaseUrl}win/guetzli.exe", "guetzli.exe", OSPlatform.Windows, x64: true)
                }
            ),
    ...
    protected override ImmutableList<string> GetArgs(string input, string output, ImageMinGuetzliOptions options)
    {
