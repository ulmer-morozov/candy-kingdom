...
public sealed class ImageMinWebp : ImageMinBinVendor<ImageMinWebpOptions>
{
    ...
    private static readonly string BaseUrl = $"https://raw.githubusercontent.com/imagemin/cwebp-bin/v{BinVersion}/vendor/";
        ...
        (
            ...
            (
                ...
                sources: new[]
                {
                    ...
                    new OsDependendSource($"{BaseUrl}win/x64/cwebp.exe", "cwebp.exe", OSPlatform.Windows, x64: true),
                }
            ),
    ...
    protected override ImmutableList<string> GetArgs(string input, string output, ImageMinWebpOptions options)
    {
